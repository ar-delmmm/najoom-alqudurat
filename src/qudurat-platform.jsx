...
const initialQuestions = [
  ...
  },
  {
    id: 7,
    section: "كمي",
    text: "قارن بين: القيمة الأولى: ١٢٥٪ من ٣٥ — القيمة الثانية: ٣٥٪ من ١٢٥",
    options: ["القيمة الأولى أكبر", "القيمة الثانية أكبر", "القيمتان متساويتان", "المعطيات غير كافية"],
    correct: 2,
    explanation:
      "١٢٥٪ من ٣٥ = ١٫٢٥ × ٣٥ = ٤٣٫٧٥، و٣٥٪ من ١٢٥ = ٠٫٣٥ × ١٢٥ = ٤٣٫٧٥. القيمتان متساويتان دائمًا لأن نسبة أ٪ من ب = نسبة ب٪ من أ.",
    video: "",
  },
  {
    id: 8,
    section: "كمي",
    text: "قارن بين: القيمة الأولى: ٢(س + ص + ع) حيث س، ص، ع زوايا مثلث — القيمة الثانية: ٣٦٠",
    options: ["القيمة الأولى أكبر", "القيمة الثانية أكبر", "القيمتان متساويتان", "المعطيات غير كافية"],
    correct: 2,
    explanation: "مجموع زوايا أي مثلث = ١٨٠، إذن ٢(س + ص + ع) = ٢ × ١٨٠ = ٣٦٠. القيمتان متساويتان.",
    video: "",
  },
  {
    id: 9,
    section: "كمي",
    text: "إذا كان طول ضلع مربع ٤ وبداخله نصف دائرة مظلّلة قطرها يساوي ضلع المربع، فما مساحة الجزء غير المظلل؟",
    options: ["١٦ + ٢ط", "١٦", "٢٨ط", "١٦ - ٢ط"],
    correct: 3,
    explanation:
      "مساحة المربع = ٤ × ٤ = ١٦. نصف قطر نصف الدائرة = ٢، فمساحتها = ½ × ط × ٢² = ٢ط. مساحة الجزء غير المظلل = ١٦ - ٢ط.",
    video: "",
  },
  {
    id: 10,
    section: "كمي",
    text: "قارن بين: القيمة الأولى: طول ضلع مربع مساحته ١٦ سم² — القيمة الثانية: نصف قطر دائرة مساحتها ١٦ط سم²",
    options: ["القيمة الأولى أكبر", "القيمة الثانية أكبر", "القيمتان متساويتان", "المعطيات غير كافية"],
    correct: 2,
    explanation:
      "ضلع المربع = جذر ١٦ = ٤. نصف قطر الدائرة: ط×نق² = ١٦ط ⇒ نق² = ١٦ ⇒ نق = ٤. القيمتان متساويتان.",
    video: "",
  },
  {
    id: 11,
    section: "كمي",
    text: "إذا كان س + ص = ٧، وس ص = ١٢، فما قيمة س² + ص²؟",
    options: ["٢٥", "٤٩", "٣٧", "٢٤"],
    correct: 0,
    explanation: "س² + ص² = (س + ص)² − ٢سص = ٧² − ٢×١٢ = ٤٩ − ٢٤ = ٢٥.",
    video: "",
  },
  {
    id: 12,
    section: "كمي",
    text: "اشترى رجل ٣ سيارات، فإذا كانت السيارة الثانية تزيد عن الأولى بـ ١٠,٠٠٠ ريال، والثالثة تزيد عن الثانية بـ ١٠,٠٠٠ ريال، ومجموع ما دفعه ٩٠,٠٠٠ ريال، فما قيمة السيارة الأولى؟",
    options: ["١٠,٠٠٠ ريال", "٢٠,٠٠٠ ريال", "٣٠,٠٠٠ ريال", "٤٠,٠٠٠ ريال"],
    correct: 1,
    explanation:
      "لو السيارة الأولى = س، فالثانية = س + ١٠,٠٠٠، والثالثة = س + ٢٠,٠٠٠. المجموع = ٣س + ٣٠,٠٠٠ = ٩٠,٠٠٠ ⇒ س = ٢٠,٠٠٠.",
    video: "",
  },
  {
    id: 13,
    section: "كمي",
    text: "أكمل المتتابعة التالية: ٣، ٧، ١٥، ٣١، ٦٣، ...",
    options: ["١٢٧", "١٢٦", "١٢٥", "١٢٨"],
    correct: 0,
    explanation: "كل حد = الحد السابق × ٢ + ١، إذن الحد التالي = ٦٣ × ٢ + ١ = ١٢٧.",
    video: "",
  },
  {
    id: 14,
    section: "كمي",
    text: "إذا كان عمر محمد ثلاثة أضعاف عمر أحمد، وعمر أحمد يزيد عن عمر علي بـ ٥ سنوات، فإذا كان عمر علي ١٠ سنوات، فكم عمر محمد؟",
    options: ["٣٠ سنة", "٤٥ سنة", "٤٠ سنة", "٣٥ سنة"],
    correct: 1,
    explanation: "عمر أحمد = ١٠ + ٥ = ١٥. عمر محمد = ٣ × ١٥ = ٤٥ سنة.",
    video: "",
  },
  {
    id: 15,
    section: "كمي",
    text: "قارن بين: القيمة الأولى: مجموع زوايا الشكل السداسي المنتظم — القيمة الثانية: ٧٢٠ درجة",
    options: ["القيمة الأولى أكبر", "القيمة الثانية أكبر", "القيمتان متساويتان", "المعطيات غير كافية"],
    correct: 2,
    explanation:
      "مجموع زوايا مضلع منتظم عدد أضلاعه ن = (ن − ٢) × ١٨٠. للسداسي: (٦ − ٢) × ١٨٠ = ٧٢٠. القيمتان متساويتان.",
    video: "",
  },
  {
    id: 16,
    section: "كمي",
    text: "إذا تبرع خالد بنصف ماله، ثم وهب لأخيه ثلث الباقي، فما الكسر الذي يمثل ما تبقى معه؟",
    options: ["١/٣", "١/٤", "١/٦", "١/٢"],
    correct: 0,
    explanation:
      "بعد التبرع بالنصف يتبقى ١/٢. يهب ثلث الباقي = ١/٣ × ١/٢ = ١/٦. المتبقي = ١/٢ − ١/٦ = ١/٣.",
    video: "",
  },
];
    ...
    <div dir="rtl" style={{ ...FONT, backgroundColor: C.bg, minHeight: "100vh", color: C.ink }}>
      ...
      >
        <button onClick={() => setView("home")} className="flex items-center gap-2">
          <img src="/logo-icon-512.png" alt="نجوم القدرات" className="w-[100px] h-[100px] object-contain" />
